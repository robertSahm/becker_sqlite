...
Feature.create([
  {type: 'guitar', name: "Body Style",      position: 1 , description: "Body and neck build style", category: "wood"},
  {type: 'guitar', name: "Wood",            position: 2 , description: "Wood of the main body", category: "wood"},
  {type: 'guitar', name: "Headstock",       position: 3 , description: "Style of the headstock", category: "wood"},
  {type: 'guitar', name: "Top",             position: 4 , description: "Wood inlay attached to body and heastock", category: "wood"},
  {type: 'guitar', name: "Trimlays",        position: 5 , description: "Vertical wood accents", category: "wood"},
  {type: 'guitar', name: "Color",           position: 6,  description: "Paint color", category: "paint"},
  {type: 'guitar', name: "Finish",          position: 7 , description: "Paint finish", category: "paint"},
  {type: 'guitar', name: "Neck",            position: 8,  description: "number of frets and inlays", category: "neck"},
  {type: 'guitar', name: "Strings",         position: 9,  description: "number of strings", category: "neck"},
  {type: 'guitar', name: "Scale Length",    position: 10, description: "scale length of the neck in inches", category: "neck"},
  {type: 'guitar', name: "Curvature",       position: 11, description: "curvature of the back of the neck", category: "neck"},
  {type: 'guitar', name: "Fingerboard",     position: 12, description: "wood choices for the fingerboard", category: "neck"},
  {type: 'guitar', name: "Frets",           position: 13, description: "metal options for frets", category: "neck"},
  {type: 'guitar', name: "Pickups",         position: 14, description: "pickup options", category: "electronics"},
  {type: 'guitar', name: "Acoustic Pickup", position: 15, description: "Piezo pickup for cavity bodies", category: "electronics"},
  {type: 'guitar', name: "Computer Pickup", position: 16, description: "Digital guitar translator for computer", category: "electronics"},
  {type: 'guitar', name: "Electronics",     position: 17, description: "curvature of the back of the neck", category: "electronics"},
  {type: 'guitar', name: "Hardware",        position: 18, description: "knobs, switched, bridge, pickup cases", category: "electronics"},
  {type: 'guitar', name: "Case",            position: 19, description: "choose a custom case for your instrument", category: "accessories"},
  {type: 'guitar', name: "Insurance",       position: 20, description: "insurance helps with any repairs or breaks if they should happen", category: "accessories"},
  {type: 'guitar', name: "Play Pack",       position: 21, description: "strap , picks , strings and towel for your instrument", category: "accessories"},
  {type: 'bass', name: "Body Style",      position: 1 , description: "Body and neck build style", category: "wood"},
  {type: 'bass', name: "Wood",            position: 2 , description: "Wood of the main body", category: "wood"},
  {type: 'bass', name: "Headstock",       position: 3 , description: "Style of the headstock", category: "wood"},
  {type: 'bass', name: "Top",             position: 4 , description: "Wood inlay attached to body and heastock", category: "wood"},
  {type: 'bass', name: "Trimlays",        position: 5 , description: "Vertical wood accents", category: "wood"},
  {type: 'bass', name: "Color",           position: 6,  description: "Paint color", category: "paint"},
  {type: 'bass', name: "Finish",          position: 7 , description: "Paint finish", category: "paint"},
  {type: 'bass', name: "Neck",            position: 8,  description: "number of frets and inlays", category: "neck"},
  {type: 'bass', name: "Strings",         position: 9,  description: "number of strings", category: "neck"},
  {type: 'bass', name: "Scale Length",    position: 10, description: "scale length of the neck in inches", category: "neck"},
  {type: 'bass', name: "Curvature",       position: 11, description: "curvature of the back of the neck", category: "neck"},
  {type: 'bass', name: "Fingerboard",     position: 12, description: "wood choices for the fingerboard", category: "neck"},
  {type: 'bass', name: "Frets",           position: 13, description: "metal options for frets", category: "neck"},
  {type: 'bass', name: "Pickups",         position: 14, description: "pickup options", category: "electronics"},
  {type: 'bass', name: "Acoustic Pickup", position: 15, description: "Piezo pickup for cavity bodies", category: "electronics"},
  {type: 'bass', name: "Computer Pickup", position: 16, description: "Digital guitar translator for computer", category: "electronics"},
  {type: 'bass', name: "Electronics",     position: 17, description: "curvature of the back of the neck", category: "electronics"},
  {type: 'bass', name: "Hardware",        position: 18, description: "knobs, switched, bridge, pickup cases", category: "electronics"},
  {type: 'bass', name: "Case",            position: 19, description: "choose a custom case for your instrument", category: "accessories"},
  {type: 'bass', name: "Insurance",       position: 20, description: "insurance helps with any repairs or breaks if they should happen", category: "accessories"},
  {type: 'bass', name: "Play Pack",       position: 21, description: "strap , picks , strings and towel for your instrument", category: "accessories"} 
  {type: 'mandolin', name: "Body Style",      position: 1 , description: "Body and neck build style", category: "wood"},
  {type: 'mandolin', name: "Wood",            position: 2 , description: "Wood of the main body", category: "wood"},
  {type: 'mandolin', name: "Headstock",       position: 3 , description: "Style of the headstock", category: "wood"},
  {type: 'mandolin', name: "Top",             position: 4 , description: "Wood inlay attached to body and heastock", category: "wood"},
  {type: 'mandolin', name: "Trimlays",        position: 5 , description: "Vertical wood accents", category: "wood"},
  {type: 'mandolin', name: "Color",           position: 6,  description: "Paint color", category: "paint"},
  {type: 'mandolin', name: "Finish",          position: 7 , description: "Paint finish", category: "paint"},
  {type: 'mandolin', name: "Neck",            position: 8,  description: "number of frets and inlays", category: "neck"},
  {type: 'mandolin', name: "Strings",         position: 9,  description: "number of strings", category: "neck"},
  {type: 'mandolin', name: "Scale Length",    position: 10, description: "scale length of the neck in inches", category: "neck"},
  {type: 'mandolin', name: "Curvature",       position: 11, description: "curvature of the back of the neck", category: "neck"},
  {type: 'mandolin', name: "Fingerboard",     position: 12, description: "wood choices for the fingerboard", category: "neck"},
  {type: 'mandolin', name: "Frets",           position: 13, description: "metal options for frets", category: "neck"},
  {type: 'mandolin', name: "Pickups",         position: 14, description: "pickup options", category: "electronics"},
  {type: 'mandolin', name: "Acoustic Pickup", position: 15, description: "Piezo pickup for cavity bodies", category: "electronics"},
  {type: 'mandolin', name: "Computer Pickup", position: 16, description: "Digital guitar translator for computer", category: "electronics"},
  {type: 'mandolin', name: "Electronics",     position: 17, description: "curvature of the back of the neck", category: "electronics"},
  {type: 'mandolin', name: "Hardware",        position: 18, description: "knobs, switched, bridge, pickup cases", category: "electronics"},
  {type: 'mandolin', name: "Case",            position: 19, description: "choose a custom case for your instrument", category: "accessories"},
  {type: 'mandolin', name: "Insurance",       position: 20, description: "insurance helps with any repairs or breaks if they should happen", category: "accessories"},
  {type: 'mandolin', name: "Play Pack",       position: 21, description: "strap , picks , strings and towel for your instrument", category: "accessories"}  
  {type: 'banjo', name: "Body Style",      position: 1 , description: "Body and neck build style", category: "wood"},
  {type: 'banjo', name: "Wood",            position: 2 , description: "Wood of the main body", category: "wood"},
  {type: 'banjo', name: "Headstock",       position: 3 , description: "Style of the headstock", category: "wood"},
  {type: 'banjo', name: "Top",             position: 4 , description: "Wood inlay attached to body and heastock", category: "wood"},
  {type: 'banjo', name: "Trimlays",        position: 5 , description: "Vertical wood accents", category: "wood"},
  {type: 'banjo', name: "Color",           position: 6,  description: "Paint color", category: "paint"},
  {type: 'banjo', name: "Finish",          position: 7 , description: "Paint finish", category: "paint"},
  {type: 'banjo', name: "Neck",            position: 8,  description: "number of frets and inlays", category: "neck"},
  {type: 'banjo', name: "Strings",         position: 9,  description: "number of strings", category: "neck"},
  {type: 'banjo', name: "Scale Length",    position: 10, description: "scale length of the neck in inches", category: "neck"},
  {type: 'banjo', name: "Curvature",       position: 11, description: "curvature of the back of the neck", category: "neck"},
  {type: 'banjo', name: "Fingerboard",     position: 12, description: "wood choices for the fingerboard", category: "neck"},
  {type: 'banjo', name: "Frets",           position: 13, description: "metal options for frets", category: "neck"},
  {type: 'banjo', name: "Pickups",         position: 14, description: "pickup options", category: "electronics"},
  {type: 'banjo', name: "Acoustic Pickup", position: 15, description: "Piezo pickup for cavity bodies", category: "electronics"},
  {type: 'banjo', name: "Computer Pickup", position: 16, description: "Digital guitar translator for computer", category: "electronics"},
  {type: 'banjo', name: "Electronics",     position: 17, description: "curvature of the back of the neck", category: "electronics"},
  {type: 'banjo', name: "Hardware",        position: 18, description: "knobs, switched, bridge, pickup cases", category: "electronics"},
  {type: 'banjo', name: "Case",            position: 19, description: "choose a custom case for your instrument", category: "accessories"},
  {type: 'banjo', name: "Insurance",       position: 20, description: "insurance helps with any repairs or breaks if they should happen", category: "accessories"},
  {type: 'banjo', name: "Play Pack",       position: 21, description: "strap , picks , strings and towel for your instrument", category: "accessories"}
  {type: 'lap_steel', name: "Body Style",      position: 1 , description: "Body and neck build style", category: "wood"},
  {type: 'lap_steel', name: "Wood",            position: 2 , description: "Wood of the main body", category: "wood"},
  {type: 'lap_steel', name: "Headstock",       position: 3 , description: "Style of the headstock", category: "wood"},
  {type: 'lap_steel', name: "Top",             position: 4 , description: "Wood inlay attached to body and heastock", category: "wood"},
  {type: 'lap_steel', name: "Trimlays",        position: 5 , description: "Vertical wood accents", category: "wood"},
  {type: 'lap_steel', name: "Color",           position: 6,  description: "Paint color", category: "paint"},
  {type: 'lap_steel', name: "Finish",          position: 7 , description: "Paint finish", category: "paint"},
  {type: 'lap_steel', name: "Neck",            position: 8,  description: "number of frets and inlays", category: "neck"},
  {type: 'lap_steel', name: "Strings",         position: 9,  description: "number of strings", category: "neck"},
  {type: 'lap_steel', name: "Scale Length",    position: 10, description: "scale length of the neck in inches", category: "neck"},
  {type: 'lap_steel', name: "Curvature",       position: 11, description: "curvature of the back of the neck", category: "neck"},
  {type: 'lap_steel', name: "Fingerboard",     position: 12, description: "wood choices for the fingerboard", category: "neck"},
  {type: 'lap_steel', name: "Frets",           position: 13, description: "metal options for frets", category: "neck"},
  {type: 'lap_steel', name: "Pickups",         position: 14, description: "pickup options", category: "electronics"},
  {type: 'lap_steel', name: "Acoustic Pickup", position: 15, description: "Piezo pickup for cavity bodies", category: "electronics"},
  {type: 'lap_steel', name: "Computer Pickup", position: 16, description: "Digital guitar translator for computer", category: "electronics"},
  {type: 'lap_steel', name: "Electronics",     position: 17, description: "curvature of the back of the neck", category: "electronics"},
  {type: 'lap_steel', name: "Hardware",        position: 18, description: "knobs, switched, bridge, pickup cases", category: "electronics"},
  {type: 'lap_steel', name: "Case",            position: 19, description: "choose a custom case for your instrument", category: "accessories"},
  {type: 'lap_steel', name: "Insurance",       position: 20, description: "insurance helps with any repairs or breaks if they should happen", category: "accessories"},
  {type: 'lap_steel', name: "Play Pack",       position: 21, description: "strap , picks , strings and towel for your instrument", category: "accessories"}])
...
options_all   = [["Body Style", "bolt on neck - solid body", 0, true, true],
 ["Body Style", "neck thru - solid body", 400, false, true],
  ["Body Style", "half chamber", 800, false, true],
   ...
   ["Top", "curly maple-Q", 1000, false, true],   
