class AddFeaturesToInstruments < ActiveRecord::Migration
  def change
    ...
    add_column :instruments, "scale length"     , :integer
    ...
    add_column :instruments, "acoustic pickups" , :integer
    add_column :instruments, "computer pickups" , :integer
    ...
    add_column :instruments, "play pack"        , :integer
  end                                            
end                                               
